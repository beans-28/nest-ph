...
class ProcessEscalations extends Command
{
    ...
    protected $description = 'Advance every overdue tenant through the delinquency escalation stages (Use Case Report Tables 22-27) and resolve any that have since paid.';
