...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  @media (max-width: 600px){ .stats-row{ grid-template-columns:repeat(2, 1fr); } .sidebar{ display:none; } }
</style>
</head>
<body>
...
<div class="app">
  <aside class="sidebar">
    ...
    <ul class="nav-list">
      ...
      <li class="nav-item active" data-href="{{ route('admin.addfloor') }}" onclick="window.location.href=this.dataset.href"><span class="icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="7" height="7"/><rect x="14" y="4" width="7" height="7"/><rect x="3" y="15" width="7" height="7"/><rect x="14" y="15" width="7" height="7"/></svg></span>Vacancy Monitor</li>
