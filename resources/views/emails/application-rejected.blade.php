        ...
        <tr>
            <td style="padding:32px;">
                ...
                <p style="color:#4b5f4c;font-size:14px;line-height:1.6;margin:0 0 16px;">
                    Thank you for your interest in NEST.PH. After review, we're unable to approve your application
                    for occupancy at this time.
                </p>

                @if($application->rejection_reason)
                    <div style="background:#eeeded;border-radius:10px;padding:16px 18px;margin:0 0 16px;">
                        <p style="margin:0 0 8px;font-size:12px;color:#7a7a7a;text-transform:uppercase;letter-spacing:0.04em;">Reason</p>
                        <p style="margin:0;font-size:14px;color:#292420;line-height:1.6;white-space:pre-line;">{{ $application->rejection_reason }}</p>
                    </div>
                @endif

                <p style="color:#8a9690;font-size:12px;margin:0;">
                    If you have questions about this decision, feel free to reach out through our contact page.
                </p>
            </td>
        </tr>
    </table>
