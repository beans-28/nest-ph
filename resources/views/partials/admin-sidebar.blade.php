<aside class="sidebar" id="sidebar">
    ...
    <ul class="nav-list">
        ...
        <li class="nav-item {{ request()->routeIs('tenant-manager.*') ? 'active' : '' }}" data-href="{{ route('tenant-manager.index') }}" tabindex="0">
        ...
        <li class="nav-item {{ request()->routeIs('admin.addfloor') ? 'active' : '' }}" data-href="{{ route('admin.addfloor') }}" tabindex="0">
        ...
        <li class="nav-item {{ request()->routeIs('tickets.*') ? 'active' : '' }}" data-href="{{ route('tickets.index') }}" tabindex="0">
        ...
        <li class="nav-item {{ request()->routeIs('applications.*') ? 'active' : '' }}" data-href="{{ route('applications.index') }}" tabindex="0">
        ...
        <li class="nav-item {{ request()->routeIs('inquiries.*') ? 'active' : '' }}" data-href="{{ route('inquiries.index') }}" tabindex="0">
        ...
        <li class="nav-item {{ request()->routeIs('vr.*') ? 'active' : '' }}" data-href="{{ route('vr.index') }}" tabindex="0">
        ...
        <li class="nav-item {{ request()->routeIs('contracts.*') ? 'active' : '' }}" data-href="{{ route('contracts.index') }}" tabindex="0">
        ...
        <li class="nav-item {{ request()->routeIs('reports.*') ? 'active' : '' }}" data-href="{{ route('reports.index') }}" tabindex="0">
        ...
        <li class="nav-item {{ request()->routeIs('admin-privileges.*') ? 'active' : '' }}" data-href="{{ route('admin-privileges.index') }}" tabindex="0">
        ...
        <li class="nav-item {{ request()->routeIs('dormitory-profile.*') ? 'active' : '' }}" data-href="{{ route('dormitory-profile.index') }}" tabindex="0">
